...
#ifndef CONTROL_MSGS__MSG__DETAIL__HARDWARE_STATUS__FUNCTIONS_H_
#define CONTROL_MSGS__MSG__DETAIL__HARDWARE_STATUS__FUNCTIONS_H_
 ...
 * )) before or use
 * control_msgs__msg__HardwareStatus__create()
 ...
 * calls
 * control_msgs__msg__HardwareStatus__init().
...
/**
 * It calls
 * control_msgs__msg__HardwareStatus__fini()
 ...
 * control_msgs__msg__HardwareStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * control_msgs__msg__HardwareStatus__Sequence__fini()
 * on the array,
...
#endif  // CONTROL_MSGS__MSG__DETAIL__HARDWARE_STATUS__FUNCTIONS_H_
